...
\small
\begin{longtable}{|p{1.3cm}|p{3.8cm}|p{3.4cm}|p{7.0cm}|p{6.0cm}|p{6.0cm}|}
\caption{Prípady použitia}\label{t:use-cases}\\
\hline
\textbf{ID} & \textbf{Názov} & \textbf{Aktér} & \textbf{Popis} & \textbf{Predpodmienka} & \textbf{Výsledok} \\
\hline
\endfirsthead
\hline
\textbf{ID} & \textbf{Názov} & \textbf{Aktér} & \textbf{Popis} & \textbf{Predpodmienka} & \textbf{Výsledok} \\
\hline
\endhead
UC-01 & Prihlásenie zamestnanca & Zamestnanec &
Zamestnanec zadá svoje meno a~heslo na prihlasovacej stránke aplikácie. &
Zamestnanec má platný účet v~systéme. &
Zamestnanec je prihlásený a~presmerovaný na stránku skenovania. \\
\hline
UC-02 & Skenovanie QR kódu & Zamestnanec &
Zamestnanec nasmeruje kameru zariadenia na vytlačený QR kód; systém ho
automaticky rozpozná pomocou knižnice jsQR.js. &
Zamestnanec je prihlásený; zariadenie má funkčnú kameru. &
Záznam príchodu alebo odchodu je uložený v~databáze s~časovou pečiatkou. \\
\hline
UC-03 & Zobrazenie potvrdenia & Zamestnanec &
Po úspešnom skene systém zobrazí potvrdzovaciu správu s~typom záznamu a~časom. &
QR kód bol úspešne rozpoznaný (UC-02). &
Zamestnanec vidí vizuálne potvrdenie záznamu. \\
\hline
UC-04 & Odhlásenie & Zamestnanec / Administrátor &
Používateľ klikne na tlačidlo odhlásenia; systém zruší reláciu. &
Používateľ je prihlásený. &
Relácia je zrušená; používateľ je presmerovaný na prihlasovaciu stránku. \\
\hline
UC-05 & Prihlásenie administrátora & Administrátor &
Administrátor zadá svoje prihlasovacie údaje na osobitnej admin prihlasovacej
stránke. &
Administrátor má platný admin účet. &
Administrátor je prihlásený a~presmerovaný na admin dashboard. \\
\hline
UC-06 & Prehliadanie a~filtrovanie dochádzky & Administrátor &
Administrátor prezerá tabuľku dochádzky a~aplikuje filtre podľa mena zamestnanca,
dátumového rozsahu alebo typu záznamu. &
Administrátor je prihlásený (UC-05). &
Tabuľka zobrazí iba záznamy zodpovedajúce zvoleným filtrom. \\
\hline
UC-07 & Úprava záznamu dochádzky & Administrátor &
Administrátor vyberie konkrétny záznam a~upraví jeho hodnoty (typ, čas) cez
editačný formulár. &
Administrátor je prihlásený; záznam existuje v~databáze. &
Zmenené údaje sú uložené v~databáze a~zobrazené v~tabuľke. \\
\hline
UC-08 & Vymazanie záznamu dochádzky & Administrátor &
Administrátor vyberie záznam na vymazanie a~potvrdí akciu. &
Administrátor je prihlásený; záznam existuje v~databáze. &
Záznam je trvalo odstránený z~databázy. \\
\hline
UC-09 & Export do Excelu & Administrátor &
Administrátor klikne na tlačidlo exportu; systém vygeneruje XLSX súbor
s~aktuálne zobrazenými záznamami. &
Administrátor je prihlásený; existujú záznamy na export. &
Súbor XLSX je stiahnutý do zariadenia administrátora. \\
\hline
UC-10 & Generovanie QR kódu & Administrátor &
Administrátor vyberie zamestnanca a~nechá systém vygenerovať jeho unikátny QR
kód pomocou knižnice chillerlan/php-qrcode. &
Administrátor je prihlásený; zamestnanec je evidovaný v~systéme. &
QR kód je vygenerovaný, uložený a~dostupný na stiahnutie alebo tlač. \\
\hline
\end{longtable}
\end{landscape}
