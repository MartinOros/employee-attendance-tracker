...
\usepackage{float}
\usepackage{array}
% PlantUML JAR (pre automatické generovanie .png pri pdflatex --shell-escape)
\IfFileExists{/Users/martinoros/bin/plantuml.jar}{%
  \providecommand{\plantumljarpath}{/Users/martinoros/bin/plantuml.jar}%
}{%
...
\include{analyza}
%
% Ďalšie časti dokumentu odstránené na požiadanie – dokument končí po sekcii Testovanie.
%\include{jadroprace}
%%
%\include{zaver}
%%
